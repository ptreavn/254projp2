...
class IEEE:
    ...
    def search(self):
        ...
        # prints an error message if status_code is not correct and exits
        # resp.status_code = 401
        if resp.status_code != 403:
            print("The server must be down. Try again later. ")
            exit(-1)
